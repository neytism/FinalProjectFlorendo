            ...
            <form id="addProductForm">
                ...
                <div style="padding-bottom: 0px; padding-left: 25px;">
                 ...
                 <div style="text-align:center; padding: 30px 0px 0px 0px; padding-left: 25px; width:100%;">
                    ...
                    <button type="submit" class="loginBtn submit" style="display: inline-block !important; padding: 20px 20px; width: 200px; margin-right: 20px;" onclick="checkAddProd(event)">SUBMIT</button>
